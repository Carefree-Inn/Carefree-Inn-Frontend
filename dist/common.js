...
var TopicArticle = function TopicArticle(_ref) {
  ...
  var onLike = function onLike() {
    ...
    /* eslint-disable */
    (_console = console).log.apply(_console, Object(D_web_Project_Carefree_Inn_Fronted_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(oo_oo("da6e194e_0", query)));
    // onLikeClick(query)
    // postData('/like',{
    //   from_user_avatar: sender.avatar,
    //   from_user_nickname: user.nickname,
  ...
  var cancelLike = function cancelLike() {
    ...
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_2___default.a.navigateTo({
      ...
      events: {
        ...
        acceptDataFromOpenedPage: function acceptDataFromOpenedPage(data) {
          var _console2;
          /* eslint-disable */(_console2 = console).log.apply(_console2, Object(D_web_Project_Carefree_Inn_Fronted_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(oo_oo("da6e194e_1", data)));
        },
        someEvent: function someEvent(data) {
          var _console3;
          /* eslint-disable */(_console3 = console).log.apply(_console3, Object(D_web_Project_Carefree_Inn_Fronted_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(oo_oo("da6e194e_2", data)));
        }
      },
